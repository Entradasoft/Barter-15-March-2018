...
static CGFloat const kCSNotificationViewHeight = 35.0f;
//static CGFloat const kCSNotificationViewSymbolViewSidelength = 44.0f;
static CGFloat const kCSNotificationViewSymbolViewSidelength =31.0f;
static NSTimeInterval const kCSNotificationViewDefaultShowDuration = 2.0;


static CGFloat const kCSNotificationViewHeight_Ipad = 50.0f;
static CGFloat const kCSNotificationViewSymbolViewSidelength_Ipad =44.0f;
static NSTimeInterval const kCSNotificationViewDefaultShowDuration_Ipad = 2.0;
